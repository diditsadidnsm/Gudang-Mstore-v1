          ...
          echo "<div class='col-md-12'>
                  ...
                  <table class='table table-bordered table-striped'>
                      <thead>
                        ...
                        $no = 1;
                        $penyesuaian_detail = $this->db->query("SELECT * FROM mu_penyesuaian_detail a JOIN mu_barang b ON a.id_barang=b.id_barang where a.id_penyesuaian='".$this->uri->segment(3)."' ORDER BY a.id_penyesuaian_detail DESC");
